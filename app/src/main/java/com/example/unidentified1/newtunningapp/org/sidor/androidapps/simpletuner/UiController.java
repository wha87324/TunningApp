...
import com.example.unidentified1.newtunningapp.org.sidor.androidapps.simpletuner.SoundAnalyzer.*;
import com.example.unidentified1.newtunningapp.org.sidor.androidapps.simpletuner.Tuning.GuitarString;
	...
	private void updateUi() {
		...
		switch(message) {
			case TUNING_IN_PROGRESS:
				ui.displayMessage(Math.round(100.0*match) + "%.", true);
				break;
			case TOO_NOISY:
				ui.displayMessage("0%", false);
				break;
			case TOO_QUIET:
				ui.displayMessage("0%", false);
			default:
